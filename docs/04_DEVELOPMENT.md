...
| 품질·접근성·출시 점검 (B16) | PARTIAL | 단위 테스트 40건·번역 519키, 모의 서비스 인증 상태 검사 9건, 브라우저 320/390px 동작·치수 검사, 양 플랫폼 JS bundle 확인. 기존 Android debug APK 기록과 별개로 이번 변경의 네이티브 실기기/접근성/스토어 검증은 남음 |
